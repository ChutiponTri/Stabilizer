...
import { getCustomers, getUserByClerkId } from "@/actions/user.action";
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <div className="w-full">
              ...
              <div className="flex justify-between">
                <div>
                  <p className="text-xs text-muted-foreground">Patients: {customers.length}</p>
                </div>
                <Separator orientation="vertical" />
                <div>
                  <p className="text-xs text-muted-foreground">{
                    (device && typeof device === "object" && "device" in device) ? `Device: ${device.device}` : "No Device"}
                  </p>
                </div>
              </div>
              <Separator className="my-4" />
